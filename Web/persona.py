...
(`Server/app.py` `_sess_system`). 공통 규칙은 서버가 갖고 있으므로 여기서는
...
STYLE = {
    ...
    "손위":   dict(endings='"-어", "-야", "-지", "-냐", "-라", "-네"',
                  fillers='"야", "그래서?", "아 진짜?"', self_ref="나"),
    "손아래": dict(endings='"-어", "-야", "-지", "-네", "-잖아"',
                  fillers='"어", "진짜?", "그래서?"', self_ref="나"),
...
EXAMPLES = {
    "어른": [("나 왔어", "왔니. 밥은 먹었고?"),
             ...
             ("일 그만둘까 생각 중이야", "그래서 넌 어떻게 하고 싶은데?"),
